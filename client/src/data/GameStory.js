...
export default [
    ...
    },
    {
        ...
        options: [
            ...
            {
                text: "Continue on your journey to the Holy Club Meeting.",
                nextText: 2.1,
                action: []
            }
        ]
    ...
    {
        id: 2.1,
        title: "Leaving for the Holy Club Meeting",
        text:
            "You can travel on horse to reach your destination. If you have multiple horses, you can get there quicker.",
        image:
    ...
    {
        id: 3,
        title: "Holy Club Meeting",
        text:
            "The Holy Club was agroup of Oxford students, formed in 1729 by brothers John and Charles Wesley, who later contributed to the formation of the Methodist Church. The brothers and associates, including George Whitefield, met for prayer, Bible study, and pious discipline.",
        image:
