...
export default [
  ...
  },
  {
    ...
    options: [
      ...
      {
        text: 'Would you like to purchase supplies?(20)',
        nextText: 2,
        action: [4, 14],
        hideIfAlreadyHas: 0,
        cost: 20,
      ...
      {
        text: 'Would you like to purchase a horse for your travels?(10)',
        nextText: 2,
        action: [5, 14],
        cost: 10,
      },
      {
        text: 'Continue on your journey to a Society',
        nextText: 2.1,
        action: [],
      },
    ],
  ...
  },
  {
    ...
    text: 'Welcome to a Society, a gathering of early Methodists for worship and prayer. This is where you can gain energy for the work ahead.',
    image:
  ...
  },
  {
    ...
    options: [
      {
        text: 'Go back to the Society Meeting',
        nextText: 3,
        action: [12, 8],
      },
      {
  ...
  {
    id: 4,
    title: 'Leaving the Society Meeting',
    text: 'After a relatively peaceful day of riding on the horse, you decide to continue your adventure.',
    image:
      'https://res.cloudinary.com/https-pilot-tune-herokuapp-com/image/upload/v1668096817/bristol_u8ofa1.gif',
    progress: 12,
    options: [
      {
        text: 'Visit Children in Poverty',
        nextText: 4,
        action: [17],
      },
      {
        text: 'Visit Prisoners at Castle Prison',
        nextText: 4,
        action: [18],
      },
    ],
